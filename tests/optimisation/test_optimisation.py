...
def test_run_optimisation_no_batching(optimiser: BFGS, batch: ConformerBatch) -> ConformerBatch:
    """Test running optimisation without batching."""
    out = run_optimisation(conformers=batch, optimiser=optimiser, batch_size=1, num_workers=0)
...
def test_run_optimisation_batching(optimiser: BFGS, batch: ConformerBatch) -> ConformerBatch:
    """Test running optimisation with batching."""
    out = run_optimisation(conformers=batch, optimiser=optimiser, batch_size=3, num_workers=0)
