...
class StrainReliefBFGS(BFGS):
    ...
    def log(self):
        ...
        if self.nsteps >= self.max_steps:
            msg = f"{name} CONFORMER NOT CONVEREGED: Steps = {self.nsteps}, fmax = {self.n_fmax}, E = {e} (max steps = {self.max_steps})"
        elif self.n_fmax > self.fexit:
            msg = f"{name} CONFORMER NOT CONVEREGED: Steps = {self.nsteps}, fmax = {self.n_fmax}, E = {e} (fmax > {self.fexit})"
        elif self.converged():
            msg = (
